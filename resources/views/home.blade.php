...
<body>
                ...
                <div class="col-12 col-lg-10">
                    <div class="menu_area">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <!-- Logo -->
                            <img src="img/bg-img/logo-dark.png" />
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ca-navbar" aria-controls="ca-navbar" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                            <!-- Menu Area -->
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    <li class="nav-item active"><a class="nav-link" href="#home">ACEUIL</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#about">À PROPOS</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#features">ACTUALITE</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#screenshot">XPERTPHARM</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#pricing">XPERTASSIST</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#testimonials">TARIFS</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#team">CONTACT</a></li>
                                </ul>
                                <div class="sing-up-button d-lg-none">
                                    <a href="#">Support en ligne</a>
                                </div>
                            </div>
                        </nav>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        <h2>XpertSoft Votre Incontournable Partenaire De Géstion Officine/Pharmacie</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="special_description_content text-center">
                        <p>
                            Vous êtes actuellement à la recherche d'un partenaire capable de vous accompagner dans la gestion normative de votre officine,
                            XpertSoft intervient dans ce domaine en vous proposant la meilleure solution, son logiciel XPERTPHARM. Vous y trouverez,
                            plus loin, toutes les informations concernant cet indispensable outil.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="footer-text">
                        <p>Vos questions et / ou vos proposition à nous soumettre !
                            N’hésitez surtout pas à nous joindre, nous nous ferons un plaisir de vous répondre dans un délai record.</p>
                    </div>
                    <div class="address-text">
                        <p><span>Direction Générale :</span> Coop. Immo. EL-KHALIDJ Oued FOURCHA N° 122 ANNABA</p>
                    </div>
                    <div class="address-text">
                        <p><span>Bureau Alger- SARL ADVANCED SOFTWARE SOLUTIONS :</span> Bureau 1215, 6e étage, Mohammadia Mall, Alger</p>
                    </div>
                    <div class="address-text">
                        <p><span>Bureau Oran</span> Hai Ennakhla, Canastel, local N° 40 ORAN</p>
                    </div>
                    <div class="phone-text">
                        <p><span>Commercial:</span> 0560 99 80 82/3/4/5</p>
                    </div>
                    <div class="phone-text">
                        <p><span>Support:</span> 0561 68 59 22/3/4/5/6/7</p>
                        <p> 038 45 30 29</p>
                    </div>
                    <div class="email-text">
                        <p><span>Email:</span> support@xpertsoft-dz.com</p>
                        <p>info@xpertsoft-dz.com</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Form Start-->
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="contact_input_area">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Officine" required>
                                        </div>
                                    </div>
                                    <!-- Single Input Area Start -->
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Wilaya" required>
                                        </div>
                                    </div>
                                    <!-- Single Input Area Start -->
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="name" id="name" placeholder="Commune" required>
                                        </div>
                                    </div>
                                    <!-- Single Input Area Start -->
                                    <div class="col-md-12">
    ...
    <footer class="footer-social-icon text-center section_padding_70 clearfix">
        ...
        <div class="copyright-text">
            ...
            <p>Copyright ©2017 Ca. Designed by <a href="https://colorlib.com" target="_blank">Colorlib</a> Distributed By: <a class="" href="https://htmltemplates.co" target="_blank">HTML Templates</a></p>
        </div>
    </footer>
    <!-- ***** Footer Area Start ***** -->
